...
<head>
    ...
    <meta name="description" content="Allows users to import data or export their activity data" />
    <meta name="keywords" content="WYDRN, Import Export" />
...
<button onclick="topFunction()" id="BackToTopBtn" title="Go to top">&#8657;</button>
    <div class="container">
        ...
        <button class="button-5" onclick="window.location.href='../profile.php'">⬅<img src="../images/Icons/profile.png" width="30px" height="30px"></button>
        ...
        <div class="buttons">
            ...
            <!--3 BUTTONS DISPLAYING IMPORT/EXPORT OPTIONS--->
            <div class="parent">
