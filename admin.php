...
<body>
    ...
    <div class="container">
        ...
        <div class="stat-item">Total Media Logged on WYDRN by all users: <span> <?php echo($total_media_count) ?> </span></div>
        <div class="stat-item">Total Active Visitors On Site: <span> <?php echo($current_active_users) ?></span></div>
