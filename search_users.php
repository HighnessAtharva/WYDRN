...
<head>
    ...
    <meta name="description" content="Search users, see top followed and most active users" />
    <meta name="keywords" content="WYDRN, search users" />
            ...
            <article class="leaderboard column">
                <header>
                    ...
                    <h1 class="leaderboard__title"><span class="leaderboard__title--top">WYDRN</span>
                        <span class="leaderboard__title--bottom">Most Followed Users</span>
                    </h1>
                </header>
            </article>
