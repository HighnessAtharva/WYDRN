	...
	<div id="box" style="">
		...
		<form method="post" action="signup.php" onsubmit="return Validation();">
			...
			<i class="fa fa-user icon"></i>	
				<input class="input-field" id="name" type="text" name="user_name" placeholder="HighnessAlexDaOne" autofocus="true" required><br><br>
			</div>
			<!----------------
			E-MAIL
			------------------>
			...
			<i class="fa fa-envelope icon"></i>
				<input class="input-field" id="email" type="email" name="email" placeholder="AlexDaOne@gmail.com" required><br><br>
			</div>
			<!----------------
			PASSWORD
			------------------>
			...
			<i class="fa fa-key icon"></i>
				<input class="input-field" id="pass" type="password" name="password" placeholder="Karm@beatsDogm@" onCopy="return false" required><br><br>
			</div>
			...
			<div class="input-container">
			<i class="fa fa-key icon"></i>
				<input class="input-field" id="confirmpass" type="password" name="confirm_password" onCopy="return false" placeholder="Karm@beatsDogm@" required><br>
			</div>
